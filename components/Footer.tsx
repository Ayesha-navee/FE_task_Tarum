    ...
    <footer className="bg-gray-900 text-white">
      <div className="container-custom section-padding py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              AI Co-Founder for your business. Grow smarter, not harder.
            </p>
            <p className="text-gray-500 text-xs font-semibold">PYME WORKSPACE</p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm">
          <p>&copy; 2024 PYME Workspace. All rights reserved.</p>
